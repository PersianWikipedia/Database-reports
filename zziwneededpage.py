...
page = wikipedia.Page(faSite,u"ویکی‌پدیا:مقاله‌های مهم ایجادنشده/فهرست")
page.put(savetext,u"ربات: به روز رسانی")


sign_page=u'ویکی‌پدیا:گزارش دیتابیس/مقاله‌های مهم ایجادنشده بر پایه دیگر میان‌ویکی‌ها/امضا'
madak=u'~~~~~'
